...
class BasePlugin:
    ...
    async def global_before_message_checks(self, msg):
        ...
        be processed or `False` if nothing should be processed. Executed \
        before message was checked"
        return True
    ...
    async def global_before_event_checks(self, evnt):
        ...
        or `False` if nothing should be processed. Executed before message \
        was checked"
        return True
